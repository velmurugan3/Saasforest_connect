...
return new class extends Migration
{
    ...
    {
        Schema::create('payrun_employee_allowances', function (Blueprint $table) {
            $table->id();
            $table->foreignId('payrun_employee_id')->constrained()->onDelete('cascade');
            $table->foreignId('allowance_id')->nullable()->constrained()->onDelete('set null');
    ...
    {
        Schema::dropIfExists('payrun_employee_allowances');
    }
};
