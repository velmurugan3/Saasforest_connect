...
class Allowance extends Model
{
    ...
    {
        return $this->hasMany(PayrunEmployeeAllowance::class, 'allowance_id');
    }
    public function payrunEmployeeDeduction()
    {
        return $this->hasMany(PayrunEmployeeDeduction::class, 'allowance_id');
    }
    ...
    {
        return $this->hasMany(PayrollPolicyAllowance::class, 'allowance_id');
    }
